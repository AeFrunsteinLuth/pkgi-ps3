...
// PDB-related data
extern const uint8_t install_data_pdb[INSTALL_DATA_PDB_SIZE];
extern const uint8_t mp4_d0top_data[D0TOP_DATA_SIZE];
extern const uint8_t jpg_d0top_data[D0TOP_DATA_SIZE];
extern const uint8_t pkg_d0top_data[D0TOP_DATA_SIZE];
extern const uint8_t pkg_d0end_data[PKG_D0END_DATA_SIZE];
extern const uint8_t other_d0end_data[52];
extern const uint8_t iconfile_data[ICONFILE_DATA_SIZE];

// TMDB HMAC key
extern const uint8_t tmdb_hmac_key[64];

// ---------------------------------------------------------------------
// https://www.psdevwiki.com/ps3/Project_Database_(PDB)
// ---------------------------------------------------------------------
const uint8_t install_data_pdb[INSTALL_DATA_PDB_SIZE] = {
...
const uint8_t mp4_d0top_data[D0TOP_DATA_SIZE] = {
...
const uint8_t jpg_d0top_data[D0TOP_DATA_SIZE] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00, 0x04,
	0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x65,
	0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x66, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01,
...
const uint8_t pkg_d0top_data[D0TOP_DATA_SIZE] = {
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x64, 0x00, 0x00, 0x00, 0x04,
	0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x65,
...
const uint8_t pkg_d0end_data[PKG_D0END_DATA_SIZE] = {
...
const uint8_t other_d0end_data[52] = {
...
const uint8_t iconfile_data[ICONFILE_DATA_SIZE] = {
...
// ---------------------------------------------------------------------
const uint8_t tmdb_hmac_key[64] = {
